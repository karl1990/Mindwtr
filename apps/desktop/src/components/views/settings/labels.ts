export const labelFallback = {
    en: {
        ...
        email: 'Email Capture',
        emailDesc: 'Connect to an IMAP mailbox and turn incoming emails into inbox tasks. Your password is stored securely in the OS keychain and never synced.',
        emailEnable: 'Enable email capture',
        emailServer: 'IMAP server',
        emailPort: 'Port',
        emailTls: 'Use TLS',
        emailUsername: 'Username',
        emailPassword: 'Password',
        emailPasswordHint: 'Stored in OS keychain. Never synced.',
        emailActionFolder: 'Action folder',
        emailActionPrefix: 'Task title prefix (action)',
        emailWaitingFolder: 'Waiting-for folder',
        emailWaitingPrefix: 'Task title prefix (waiting)',
        emailPrefixHint: 'Prepended to the email subject. Leave blank for no prefix.',
        emailPollInterval: 'Poll interval (minutes)',
        emailPollIntervalHint: 'How often to check for new emails.',
        emailArchiveAction: 'After processing',
        emailArchiveMove: 'Move to folder',
        emailArchiveDelete: 'Delete',
        emailArchiveFolder: 'Archive folder',
        emailTagNewTasks: 'Tag new tasks',
        emailTagNewTasksHint: 'Optional tag to apply to tasks created from emails.',
        emailTestConnection: 'Test Connection',
        emailTesting: 'Testing...',
        emailTestSuccess: 'Connected successfully',
        emailFetchNow: 'Fetch Now',
        emailFetching: 'Fetching...',
        emailFetchSuccess: 'Fetch complete',
        emailLastPoll: 'Last poll',
        emailLastPollNever: 'Never',
        emailTasksCreated: 'tasks created',
        emailAccountLabel: 'Account label',
        emailAccountLabelHint: 'A friendly name for this account (e.g., "Work Gmail").',
        emailAddAccount: 'Add account',
        emailRemoveAccount: 'Remove account',
        emailRemoveAccountConfirm: 'Remove this email account? The password will be deleted from the keychain.',
        emailMaxAccounts: 'Maximum of 10 accounts reached.',
        emailNoAccounts: 'No email accounts configured. Click + to add one.',
        emailGuideTitle: 'IMAP Connection Guide',
    ...
    zh: {
        ...
        email: '邮件捕获',
        emailDesc: '连接 IMAP 邮箱，将收到的邮件转为收集箱任务。密码安全存储在系统钥匙串中，不会同步。',
        emailEnable: '启用邮件捕获',
        ...
        emailUsername: '用户名',
        emailPassword: '密码',
        emailPasswordHint: '存储在系统钥匙串中，不会同步。',
        emailActionFolder: '动作文件夹',
        emailActionPrefix: '任务标题前缀（动作）',
        emailWaitingFolder: '等待文件夹',
        emailWaitingPrefix: '任务标题前缀（等待）',
        emailPrefixHint: '添加到邮件主题前。如不需要前缀，请留空。',
        emailPollInterval: '轮询间隔（分钟）',
        emailPollIntervalHint: '多久检查一次新邮件。',
        emailArchiveAction: '处理后操作',
        emailArchiveMove: '移动到文件夹',
        emailArchiveDelete: '删除',
        emailArchiveFolder: '归档文件夹',
        emailTagNewTasks: '新任务标签',
        emailTagNewTasksHint: '可选标签，应用到从邮件创建的任务。',
        emailTestConnection: '测试连接',
        emailTesting: '测试中...',
        emailTestSuccess: '连接成功',
        emailFetchNow: '立即获取',
        emailFetching: '获取中...',
        emailFetchSuccess: '获取完成',
        emailLastPoll: '上次轮询',
        emailLastPollNever: '从未',
        emailTasksCreated: '个任务已创建',
        emailAccountLabel: '账户标签',
        emailAccountLabelHint: '为此账户取个友好名称（例如"工作 Gmail"）。',
        emailAddAccount: '添加账户',
        emailRemoveAccount: '删除账户',
        emailRemoveAccountConfirm: '确定删除此邮件账户？密码将从钥匙串中删除。',
        emailMaxAccounts: '最多支持 10 个账户。',
        emailNoAccounts: '尚未配置邮件账户。点击 + 添加一个。',
        emailGuideTitle: 'IMAP 连接指南',
        saved: '设置已保存',
